create or replace procedure rrhh.CHEQUEA_FUNCIONARIO_DIARIO_SOLO_1  (   V_ID_FUNCIONARIO in varchar2)
is
...
END LOOP; CLOSE C1;
   ...
   commit;
end CHEQUEA_FUNCIONARIO_DIARIO_SOLO_1 ;
/
