...
i_id_grado varchar2(512);
i_id_tipo_dias varchar2(512);
...
BEGIN
    ...
    into   i_id_ano ,
           ...
           i_id_funcionario,
           i_DESC_TIPO_PERMISO,
           i_CADENA2,v_t1,v_t2,v_t3,v_id_justificacion
...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
     i_no_hay_firma:=-1;
END;
--quitado la comprobacion 8 06 2009
--firmas
/*
...
IF i_id_estado =22 then --Visto Bueno por parte de RRHH
            ...
            IF V_ID_FIRMA=1 THEN --AUTORIZADO
                ...
                --El funcionario Ficha ??
                 ...
                 IF I_FICHA = 1  AND I_ID_TIPO_PERMISO<>'15000' and v_id_justificacion='SI' then--chm14/02/2018
                ...
                --ENVIO DE CORREO AL FUNCIONARIO, JEFE DE AREA, JEFE DE SERV/SECC
                 ...
                 i_subject:='Permiso Concedido.';
                   ...
                   --sustituido funcion 23/12/2016 CHM
                   --Descripcion del permiso .
                       envia_correo_informa_new('3', i_ID_TIPO_PERMISO,
                       i_nombre_peticion,
                       i_DESC_TIPo_PERMISO,
                       v_id_motivo ,
                       i_fecha_inicio ,
                    ...
                    --Añadido a petición de Ramon Montejo 11/07/2017
                    IF  i_id_js='rmontejo' or   i_id_js='slopez'      then
                    envio_correo(i_sender ,
                              'hprieto@aytosalamanca.es' ,
                              I_ccrecipient ,
                              i_subject ,
                              I_message);
                    END IF;
  ...
  ELSE  IF V_ID_FIRMA=0 THEN --denegado
               update permiso
                ...
                END IF;
                 ...
                 i_sender:='permisos.rrhh@aytosalamanca.es'; --Falta poner direccion RRHH
                 I_ccrecipient:=correo_js ||';' || correo_ja||';' ;
                 i_recipient:= correo_v_funcionario;
