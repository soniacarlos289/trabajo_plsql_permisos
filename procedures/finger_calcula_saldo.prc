CREATE OR REPLACE PROCEDURE RRHH."FINGER_CALCULA_SALDO" (i_funcionario   in varchar2,
 ...
 select distinct id_funcionario,nvl(tipo_funcionario2, 0)
      ...
      where --chm 16/03/2021 fecha_fin_contrato pot fecha_bajaa
        ...
        and
       (id_funcionario=i_funcionario OR 0=i_funcionario)  )
 union
 select   to_char(101207) ,10 from dual where 101207=i_funcionario
 union
 select   to_char(10013),10   from dual where 10013=i_funcionario
 order by 1;
--961487
        ...
        delete fichaje_incidencia
         ...
         where  id_funcionario= i_id_funcionario and
                ...
                BEGIN
                 select count(*)
                        into  I_Baja
                 from rrhh.permiso p, personal_new pe  ,   apliweb_usuario u
